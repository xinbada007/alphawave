...
# 从窗口内峰值回撤阈值（负数）；只有与下跌日放量组合时才进入 summary pressure。
PATH_DRAWDOWN_60D_CONFIRMED_THRESHOLD: Final[float] = -0.18
PATH_DRAWDOWN_20D_CONFIRMED_THRESHOLD: Final[float] = -0.10
