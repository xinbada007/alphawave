...
class BaseFetcher(ABC):
    ...
    2. 轨道 2：事件流与异构数据 (无损透传) - insider_trading, dividends, splits
            ...
            for item in raw_data:
                ...
                if date_val:
                    try:
                        ...
                        pass
                # 🚀 只有 Debug 模式才保留 raw_provider_data，与轨道 1 保持一致
                if is_debug:
    ...
    # ==========================================
    def _infer_period_context(self, task_name: str) -> Tuple[Optional[ReportPeriod], Optional[bool]]:
        """
        动态推断报表周期属性。
